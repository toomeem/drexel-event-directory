...
export function EventCard({event}: EventCardProps) {
    ...
    return (
        <article className="event-card" onClick={handleClick} role="button" tabIndex={0}
            ...
            <div className="event-card__body">
                <p className="event-card__time">
                    <svg className="event-card__icon" viewBox="0 0 24 24" width="14" height="14" fill="currentColor"
                         aria-hidden="true">
